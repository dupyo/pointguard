...
public class SensorInfoDTO {
	...
	public String getMt_loc_x() {
		return mt_loc_x;
	}
	public void setMt_loc_x(String mt_loc_x) {
		this.mt_loc_x = mt_loc_x;
	}
	public String getMt_loc_y() {
		return mt_loc_y;
	}
	public void setMt_loc_y(String mt_loc_y) {
		this.mt_loc_y = mt_loc_y;
	}
